...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen selection-sonserina text-foreground bg-background relative overflow-x-hidden">
      ...
      <section className="relative pt-2 md:pt-4 pb-10 md:pb-16 px-4 flex flex-col items-center overflow-hidden min-h-[70vh] justify-start md:justify-center text-center mystic-fog">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="mb-4 inline-flex items-center gap-3 py-1.5 px-6 border border-primary/30 bg-primary/10 text-primary text-[10px] font-bold tracking-[0.5em] uppercase sanctuary-glow">
            <Compass className="w-3.5 h-3.5" />
            Iniciação Gratuita • Grupo VIP
          </div>
          <h1 className="text-4xl md:text-7xl font-headline text-foreground mb-4 leading-[1.2] scroll-reveal">
            Safe & Sound: <br />
          ...
          <p className="text-base md:text-lg text-muted-foreground mb-6 max-w-2xl font-body scroll-reveal delay-200 leading-relaxed mx-auto">
          ...
          <p className="mt-4 text-[10px] uppercase tracking-[0.4em] text-primary/60 font-bold scroll-reveal delay-400">
      ...
      <section className="py-12 md:py-16 bg-card/20 border-y border-primary/10 relative overflow-hidden px-4 mystic-fog">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-3xl md:text-5xl font-headline text-foreground mb-10 scroll-reveal leading-tight">
          ...
          <div className="space-y-6 text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-12 scroll-reveal">
            <p>
          ...
          <div className="max-w-3xl mx-auto mb-12 scroll-reveal delay-200">
            <div className="brand-card backdrop-blur-md border-l-4 border-primary p-8 md:p-10 text-left sanctuary-glow mistic-border">
      ...
      <section className="py-12 md:py-16 px-4 relative overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <div className="ornament-line mx-auto max-w-sm mb-6 opacity-60"></div>
            <p className="text-[10px] md:text-[11px] uppercase tracking-[0.5em] text-primary/70 font-bold mb-8">Minicurso entregue via Grupo VIP de WhatsApp</p>
          </div>
            ...
            {[
              ...
              <Card key={idx} className="brand-card scroll-reveal border-primary/10">
                <CardContent className="p-8 md:p-10 text-center">
                  <span className="block text-primary/50 font-bold uppercase tracking-[0.5em] text-[10px] mb-4">{card.num}</span>
                  <h3 className="text-lg md:text-xl font-headline text-primary mb-4 tracking-[0.15em] uppercase leading-snug">{card.title}</h3>
      ...
      <section className="py-12 md:py-16 px-4 bg-card/10 border-y border-primary/10 overflow-hidden mystic-fog">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10 md:gap-16">
          <div className="w-full md:w-1/2 scroll-reveal">
            <div className="relative p-2 md:p-4 border border-primary/25 bg-background/60 group mx-auto max-w-[500px] md:max-w-full sanctuary-glow mistic-border">
              <Image 
          ...
          <div className="w-full md:w-1/2 scroll-reveal text-center md:text-left">
            <div className="mb-4 flex items-center justify-center md:justify-start gap-4 text-primary/70">
              <BookOpen className="w-5 h-5" />
              <span className="text-[10px] font-bold tracking-[0.6em] uppercase">Guia da Jornada</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-headline text-foreground mb-6 leading-tight">Eu Sou Caroline Renó</h2>
            <div className="space-y-4 text-base md:text-lg text-muted-foreground/95 leading-relaxed">
              <p>
              ...
              <p>
                Desde então, ajudei mais de <span className="magic-emphasis">1.200 profissionais</span> a destravar seu inglês usando o mesmo método. Hoje, eu ensino o que aprendi: <span className="magic-emphasis">Psicologia + Inglês + Acolhimento</span>. Tudo que ensino, eu testo em mim mesma primeiro.
              </p>
            </div>
            <div className="mt-8 pt-6 border-t border-primary/20 flex flex-col md:flex-row items-center justify-center md:justify-start gap-6 md:gap-10">
      ...
      <section className="py-12 md:py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-headline text-foreground text-center mb-12 md:mb-16 scroll-reveal tracking-[0.3em] uppercase">Quem já destravou</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {[
      ...
      <section className="py-12 md:py-16 px-4 border-t border-primary/15 mystic-fog">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-headline text-foreground text-center mb-10 md:mb-12 scroll-reveal tracking-[0.4em] uppercase">Câmara de Esclarecimentos</h2>
          <Accordion type="single" collapsible className="w-full scroll-reveal space-y-3">
            {[
              ...
              <AccordionItem key={idx} value={`item-${idx}`} className="border border-primary/10 bg-card/10 hover:bg-card/20 transition-all sanctuary-glow">
                ...
                <AccordionContent className="text-muted-foreground/90 text-sm p-6 border-t border-primary/5 leading-relaxed bg-background/30">
                  {item.a}
                </AccordionContent>
              </AccordionItem>
            ))}
      ...
      <section className="py-20 md:py-28 px-4 text-center relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10 scroll-reveal text-center">
          <h2 className="text-4xl md:text-7xl font-headline text-foreground mb-8 leading-[1.1]">
          ...
          <p className="text-primary/60 mb-8 max-w-lg mx-auto uppercase tracking-[0.5em] text-[10px] font-bold">
      ...
      {/* RODAPÉ FINAL REFINADO */}
      <footer className="py-12 md:py-16 text-center border-t border-primary/10 bg-background/95 backdrop-blur-md relative z-10 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="mb-10 transition-transform duration-700 hover:scale-105">
            <Image 
              ...
              width={180} 
              height={50} 
              className="mx-auto opacity-40 grayscale hover:opacity-100 hover:grayscale-0 transition-all duration-1000 md:w-[220px] md:h-[60px] no-drag"
            />
          </div>
          
          <div className="ornament-line mx-auto max-w-[200px] mb-8 opacity-20"></div>
          
          <p className="text-[9px] md:text-[10px] tracking-[0.5em] md:tracking-[0.8em] uppercase mb-8 text-primary/40 font-bold">
            &copy; {new Date().getFullYear()} Caroline Renó | Safe & Sound • Habilidade Ativa Academy
          </p>
          
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 text-[9px] uppercase tracking-[0.4em] font-bold text-muted-foreground/30">
            <span className="cursor-pointer hover:text-primary transition-all duration-500 hover:tracking-[0.6em] relative group">
              Termos de Uso
              <span className="absolute -bottom-1 left-0 w-0 h-[1px] bg-primary/30 transition-all duration-500 group-hover:w-full"></span>
            </span>
            <span className="cursor-pointer hover:text-primary transition-all duration-500 hover:tracking-[0.6em] relative group">

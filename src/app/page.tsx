...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen selection-sonserina text-foreground bg-background relative overflow-x-hidden">
      ...
      <section className="relative pt-2 md:pt-4 pb-12 md:pb-20 px-4 flex flex-col items-center overflow-hidden min-h-[80vh] justify-start md:justify-center text-center mystic-fog">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="mb-4 inline-flex items-center gap-3 py-2 px-8 border border-primary/30 bg-primary/10 text-primary text-[10px] md:text-[11px] font-bold tracking-[0.5em] uppercase sanctuary-glow">
            <Compass className="w-3.5 h-3.5" />
            Iniciação Gratuita • Grupo VIP
          </div>
          <h1 className="text-4xl md:text-7xl font-headline text-foreground mb-4 md:mb-6 leading-[1.2] scroll-reveal">
            Safe & Sound: <br />
            ...
            <span className="text-xl md:text-3xl block mt-2 font-body tracking-tight opacity-95">Fale Inglês Sem Medo e Destrave sua Carreira.</span>
          </h1>
        ...
        <div className="mt-12 md:mt-16 flex flex-wrap justify-center gap-8 md:gap-12 text-primary/50 font-bold tracking-[0.4em] scroll-reveal delay-500">
      ...
      <section className="py-16 md:py-24 bg-card/20 border-y border-primary/10 relative overflow-hidden px-4 mystic-fog">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="space-y-6 md:space-y-8 text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-16 scroll-reveal">
            <p>
          ...
          <div className="max-w-3xl mx-auto mb-16 scroll-reveal delay-200">
            <div className="brand-card backdrop-blur-md border-l-4 border-primary p-10 md:p-12 text-left sanctuary-glow mistic-border">
              <p className="text-xl md:text-3xl text-foreground italic leading-relaxed mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <div key={idx} className="p-8 md:p-10 brand-card scroll-reveal">
                <item.icon className="w-6 h-6 text-primary/70 mx-auto mb-6" />
      ...
      <section className="py-16 md:py-24 px-4 relative overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 md:mb-20">
            <h2 className="text-4xl md:text-7xl font-headline text-foreground mb-8 scroll-reveal">
            ...
            <p className="text-[10px] md:text-[12px] uppercase tracking-[0.5em] text-primary/70 font-bold mb-10">Minicurso entregue via Grupo VIP de WhatsApp</p>
          </div>
            ...
            {[
              ...
              <Card key={idx} className="brand-card scroll-reveal border-primary/10">
                <CardContent className="p-10 md:p-12 text-center">
                  <span className="block text-primary/50 font-bold uppercase tracking-[0.5em] text-[10px] md:text-[11px] mb-6">{card.num}</span>
                  <h3 className="text-xl md:text-2xl font-headline text-primary mb-6 tracking-[0.15em] uppercase leading-snug">{card.title}</h3>
      ...
      <section className="py-16 md:py-24 px-4 bg-card/10 border-y border-primary/10 overflow-hidden mystic-fog">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20">
          ...
          <div className="w-full md:w-1/2 scroll-reveal text-center md:text-left">
            <div className="mb-6 flex items-center justify-center md:justify-start gap-4 text-primary/70">
              <BookOpen className="w-5 h-5" />
              <span className="text-[10px] md:text-[12px] font-bold tracking-[0.6em] uppercase">Guia da Jornada</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-headline text-foreground mb-8 leading-tight">Eu Sou Caroline Renó</h2>
            ...
            <div className="mt-12 pt-10 border-t border-primary/20 flex flex-col md:flex-row items-center justify-center md:justify-start gap-8 md:gap-12">
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-headline text-foreground text-center mb-16 md:mb-20 scroll-reveal tracking-[0.3em] md:tracking-[0.4em] uppercase">Quem já destravou</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
            {[
              ...
              <div key={idx} className="p-10 md:p-12 brand-card scroll-reveal">
                <div className="flex items-center gap-6 mb-8">
                  <div className="w-[55px] h-[55px] md:w-[60px] md:h-[60px] rounded-none border border-primary/30 bg-card/80 flex items-center justify-center sanctuary-glow">
      ...
      <section className="py-24 md:py-36 px-4 text-center relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10 scroll-reveal text-center">
          <h2 className="text-4xl md:text-7xl font-headline text-foreground mb-8 md:mb-12 leading-[1.1]">
          ...
          <p className="text-primary/60 mb-10 md:mb-12 max-w-lg mx-auto uppercase tracking-[0.5em] text-[10px] md:text-[12px] font-bold">
      ...
      {/* RODAPÉ FINAL */}
      <footer className="py-16 md:py-20 text-center border-t border-primary/10 bg-background/80 relative z-10 px-4">
        <Image 
          src="https://i.imgur.com/NtUqBYp.png" 
          alt="Caroline Renó Logo" 
          width={180} 
          height={50} 
          className="mx-auto mb-10 opacity-30 grayscale hover:opacity-100 transition-all duration-1000 md:w-[220px] md:h-[60px] no-drag hover:grayscale-0"
        />
        <p className="text-[9px] md:text-[10px] tracking-[0.5em] md:tracking-[0.7em] uppercase mb-6 text-primary/40 font-bold">&copy; {new Date().getFullYear()} Caroline Renó | Safe & Sound</p>

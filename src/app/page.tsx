...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen selection-sonserina text-foreground bg-background relative overflow-x-hidden">
      ...
      <section className="relative pt-12 pb-32 px-4 flex flex-col items-center overflow-hidden min-h-screen justify-center">
        {/* Elemento Gráfico de Fundo */}
        <div className="absolute top-0 right-0 opacity-10 pointer-events-none w-1/3 max-w-sm">
          <Image src="https://imgur.com/bQxd94N.png" alt="Selo Místico" width={500} height={500} />
        </div>
        
        <header className="mb-12 scroll-reveal z-10">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10">
          <div className="md:w-3/5 text-left">
            ...
            <h1 className="text-4xl md:text-6xl font-headline text-foreground mb-8 leading-tight scroll-reveal">
              Safe & Sound: <br />
              <span className="text-primary italic mystic-script text-5xl md:text-7xl block mt-2">Onde a Magia do Inglês Acontece.</span>
              <span className="text-2xl md:text-3xl block mt-4 font-body tracking-tight opacity-90">Fale Inglês sem Medo e Destrave sua Carreira.</span>
            </h1>
            <p className="text-lg text-muted-foreground mb-10 max-w-2xl font-body scroll-reveal delay-200 leading-relaxed">
            ...
            <div className="scroll-reveal delay-300 max-w-md">
              <LeadForm />
            </div>
          </div>

          <div className="md:w-2/5 scroll-reveal delay-400 relative group">
            <div className="mistic-border p-2 bg-background/40 backdrop-blur-sm">
              <Image 
              ...
              />
              <div className="absolute -bottom-4 -left-4 bg-primary p-4 border border-background shadow-2xl">
                <Image src="https://imgur.com/dHSjKcP.png" alt="Símbolo" width={24} height={24} className="invert brightness-0" />
              </div>
            </div>
          </div>
        </div>

        <div className="mt-24 flex flex-wrap justify-center gap-8 text-primary/40 font-bold tracking-[0.3em] scroll-reveal delay-500">
      ...
      <section className="py-28 bg-card/10 border-y border-primary/10 relative overflow-hidden">
        <div className="absolute top-1/2 left-0 -translate-y-1/2 opacity-5 pointer-events-none w-64">
           <Image src="https://imgur.com/7f2b52K.png" alt="Ornamental" width={500} height={500} />
        </div>
        
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <h2 className="text-3xl md:text-5xl font-headline text-foreground mb-12 scroll-reveal">
            Você sente que o seu inglês é o <br />
            <span className="text-primary italic mystic-script text-4xl md:text-6xl">‘elefante na sala’ da sua carreira?</span>
          </h2>
          
          <div className="space-y-8 text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-16 scroll-reveal">
            <p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { text: "Sensation de que 'sabe ler, mas não consegue falar'", icon: Lock },
              { text: "Perda de oportunidades de promoção", icon: Flame },
            ].map((item, idx) => (
              <div key={idx} className="p-8 brand-card scroll-reveal">
                <item.icon className="w-5 h-5 text-primary/60 mx-auto mb-6" />
                <p className="text-[11px] text-muted-foreground tracking-widest leading-relaxed font-bold uppercase">{item.text}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-24">
            <h2 className="text-4xl md:text-6xl font-headline text-foreground mb-8 scroll-reveal">
              ...
              <span className="text-primary italic mystic-script text-4xl md:text-6xl">Aulas de Defesa Contra as Travas</span>
            </h2>
            ...
            {[
              ...
              <Card key={idx} className="brand-card scroll-reveal">
                <CardContent className="p-10 text-center">
                  <span className="block text-primary/40 font-bold uppercase tracking-[0.4em] text-[10px] mb-6">{card.num}</span>
                  <h3 className="text-xl font-headline text-primary mb-6 tracking-wider uppercase">{card.title}</h3>
      ...
      <section className="py-32 px-4 bg-card/5 border-y border-primary/5">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-16">
          <div className="w-full md:w-1/2 scroll-reveal">
            <div className="relative p-3 border border-primary/10 bg-background/50 group">
              <Image 
                src={teacherImg?.imageUrl || ''} 
                alt="Caroline Renó" 
                width={600} 
          ...
          <div className="w-full md:w-1/2 scroll-reveal">
            <div className="mb-6 flex items-center gap-3 text-primary/60">
              ...
              <span className="text-[10px] font-bold tracking-[0.5em] uppercase">Guia da Jornada</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-headline text-foreground mb-8">Quem vai te guiar?</h2>
            <div className="space-y-6 text-base text-muted-foreground/90 leading-relaxed">
              <p>
            ...
            <div className="mt-12 pt-8 border-t border-primary/10 flex items-center gap-6">
               <Image src="https://imgur.com/DIW3kra.png" alt="Caroline Renó" width={160} height={50} className="opacity-60" />
      ...
      <section className="py-32 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-headline text-foreground text-center mb-20 scroll-reveal tracking-[0.3em] uppercase">Quem já destravou</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="p-10 brand-card scroll-reveal">
                <div className="flex items-center gap-4 mb-8">
                  <Image src={testi.img?.imageUrl || ''} alt={testi.name} width={50} height={50} className="rounded-none grayscale border border-primary/20" />
                  <div>
                    <h4 className="font-bold text-foreground tracking-wider uppercase text-[10px]">{testi.name}</h4>
      ...
      <section className="py-32 px-4 border-t border-primary/10">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-headline text-foreground text-center mb-16 scroll-reveal tracking-widest uppercase">FAQ</h2>
          <Accordion type="single" collapsible className="w-full scroll-reveal">
            {[
              ...
              <AccordionItem key={idx} value={`item-${idx}`} className="border-primary/10 mb-4 bg-card/5">
                ...
                <AccordionContent className="text-muted-foreground/80 text-sm p-6 border-t border-primary/5 leading-relaxed">
                  {item.a}
                </AccordionContent>
              </AccordionItem>
            ))}
      ...
      <section className="py-48 px-4 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 scroll-reveal text-center">
          <h2 className="text-4xl md:text-6xl font-headline text-foreground mb-10 leading-tight">
            Não deixe o medo decidir <br />
            <span className="text-primary italic mystic-script text-5xl md:text-8xl">o futuro da sua carreira.</span>
          </h2>
          <p className="text-muted-foreground mb-14 max-w-lg mx-auto uppercase tracking-[0.4em] text-[10px] font-bold">
      ...
      <footer className="py-20 text-center border-t border-primary/5 bg-background relative z-10">
        <Image 
          src="https://imgur.com/NtUqBYp.png" 
          alt="Caroline Renó Logo" 
          width={180} 
          height={50} 
          className="mx-auto mb-10 opacity-20 grayscale hover:opacity-100 transition-opacity duration-1000"
        />
        <p className="text-[9px] tracking-[0.5em] uppercase mb-6 text-primary/30 font-bold">&copy; {new Date().getFullYear()} Caroline Renó | Safe & Sound</p>
        <div className="flex justify-center gap-8 text-[8px] uppercase tracking-[0.3em] font-bold text-muted-foreground/30">
